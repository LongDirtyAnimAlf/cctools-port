...
int main(int argc, char *argv[])
{
    ...
    {
        snprintf(sdkpath, sizeof(sdkpath), "%s/../../lib/aarch64-ios/" SDK_DIR, execpath);
    }
    if (!dirExists(sdkpath))
    {
        snprintf(sdkpath, sizeof(sdkpath), "%s/../../../lib/aarch64-ios/" SDK_DIR, execpath);
    ...
    if (!dirExists(sdkpath))
    {
        snprintf(sdkpath, sizeof(sdkpath), "%s/../../lib/aarch64-ios/SDK", execpath);
    }
    if (!dirExists(sdkpath))
    {
        snprintf(sdkpath, sizeof(sdkpath), "%s/../../lib/aarch64-ios", execpath);
    }
    ...
    if (!dirExists(sdkpath))
    {
        snprintf(sdkpath, sizeof(sdkpath), "%s/../../lib/all-ios/" SDK_DIR, execpath);
    }
    if (!dirExists(sdkpath))
    {
        snprintf(sdkpath, sizeof(sdkpath), "%s/../../../lib/all-ios/" SDK_DIR, execpath);
    ...
    if (!dirExists(sdkpath))
    {
        snprintf(sdkpath, sizeof(sdkpath), "%s/../../lib/al-ios/SDK", execpath);
    }
    if (!dirExists(sdkpath))
    {
    ...
    if (!dirExists(sdkpath))
    {
        snprintf(sdkpath, sizeof(sdkpath), "%s/../../../lib/all-ios/SDK", execpath);
    }
    if (!dirExists(sdkpath))
    {
        snprintf(sdkpath, sizeof(sdkpath), "%s/../../../lib/all-ios", execpath);
